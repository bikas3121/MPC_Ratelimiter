...
def quantiser_configurations(QConfig, MHOQ_IMPLEMENTATION):
    """
    ...
    match MHOQ_IMPLEMENTATION:
        case mhoq_type.binary: # binary
            Vmin = 0
            Vmax = 2
            Rng = Vmax - Vmin
        case mhoq_type.scaled: # scaled
            Vmin = 0
            Vmax = 2**Nb -1
...
def get_measured_levels(Qconfig):
    ...
    # Nb, Mq, Vmin, Vmax, Rng, Qstep, YQ, Qtype = quantiser_configurations(Qconfig, MHOQ_IMPLEMENTATION)
